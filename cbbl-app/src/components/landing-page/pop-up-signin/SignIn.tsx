            ...
            <div className="w-1/3 bg-white rounded-2xl p-7 text-left">
                <div>
                    ...
                    <form className="mt-5">
                        ...
                        <input type="email" id="email" placeholder="Email" className="input-style mb-4 mt-2" autoComplete="on"/>
                        ...
                        <p className="text-center mt-5">Don&apos;t have an account? <Link href="/sign-up" className="text-[#3C604C] hover:underline font-semibold">Sign Up</Link></p>
                    </form>
                </div>
            </div>
        </div>
