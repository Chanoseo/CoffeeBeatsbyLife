...
function ProductsList() {
  ...
  if (products.length === 0) {
    return <p className="p-4 text-gray-600 text-center">No products available.</p>;
  }
          ...
          >
            ...
            <div className="w-full h-36 relative">
              <Image
                ...
                className="rounded-t-xl transition-transform duration-300 ease-in-out group-hover:scale-110 bg-amber-50"
            ...
            <div className="p-3 flex flex-col gap-3 text-left">
              <div>
                ...
                <p className="text-xs mt-1">{product.category ? product.category.name : "Uncategorized"}</p>
